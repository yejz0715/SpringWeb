	...
	<div id="wrap" align="center">
		...
		<table>
			...
			<tr>
				...
				<td width="300" align="center"><c:choose>
						<c:when test="${empty board.imagename }">
							<img src="resources/upload/noname.jsp" width="250">
						</c:when>
						<c:otherwise>
	...
	<div id="wrap" align="center">
		<form action="addReply" method="post" name="frm2">
			...
			<table>
				...
				<tr align="center">
					<td width="100">${loginUser.id}<input type="hidden"
						name="userid" value="${ loginUser.id}"></td>
				...
				<c:forEach var="reply" items="${replyList}">
					<tr>
						...
						<td align="center"><c:if test="${reply.userid==loginUser.id}">
								<input type="button" value="삭제"
									onclick="location.href='deleteReply?num=${replynum}&boardnum=${reply.boardnum}'">
							</c:if>&nbsp;</td>
					</tr>
				</c:forEach>
			</table>
